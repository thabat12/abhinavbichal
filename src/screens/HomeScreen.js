...
export default function HomeScreen() {
    ...
    HomeScreen.className = "flex flex-col items-center w-full md:w-[40rem] lg:w-[60rem] pt-[8rem] md:pt-[10rem] space-y-5 lg:space-y-16 bg-clip-padding backdrop-filter backgrop-blur-2xl bg-opacity-40 bg-white pb-10";
